...
struct ITrade : IObject
{
    ...
    // Get pricer, note that we must add the parametre "const string& base" here, or it do not compile and throw C2259!
    virtual ppricer_t pricer(const string& base) const = 0;
};
